...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, HEATER_RELAY_Pin|FAN_RELAY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : HEATER_RELAY_Pin FAN_RELAY_Pin */
  GPIO_InitStruct.Pin = HEATER_RELAY_Pin|FAN_RELAY_Pin;
